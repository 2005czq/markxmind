...
function initResizer() {
    ...
    function onMouseMove(e: MouseEvent) {
        ...
        const newContentWidth = Math.max(
            200,
            Math.min(initialContentWidth + deltaX, totalWidth - 300)
        )
...
function initView() {
    ...
    const input = document.getElementById("input") as HTMLDivElement
    const convertToXMind = document.getElementById(
        "convert-xmind"
    ) as HTMLDivElement
    const convertToXMindMark = document.getElementById(
        "convert-xmindmark"
    ) as HTMLDivElement
    const convertToSVG = document.getElementById(
        "convert-svg"
    ) as HTMLDivElement
    const convertToPNG = document.getElementById(
        "convert-png"
    ) as HTMLDivElement
